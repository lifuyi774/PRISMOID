        ...
        <div id="main-content" style="padding-left:32px; margin-right:32px">
            ...
            <section id="block1">
                ...
                <div class="well well-lg" style="padding-top:0px">
                    ...
                    <div class="row">
                        <div class="col-sm-10">
                            <h3>List of PTM types and subtypes with numbers of associated database entries:</h3>
                        </div>
                    ...
                    <div style="width: 100%;margin-top:16px;margin-bottom:0px;padding-top:8px;padding-left:8px;padding-bottom:8px;padding-right:8px;background-color:#FFFFFF;margin-left:auto;margin-right: auto;">
                        ...
                        <table id="tableSort" class="table table-bordered table-striped table-condensed table-hover"
                            ...
                            <thead>
                            <tr>
                                <th>Type<i style="float: right;font-style:normal">&#8645;</i> </th>
                                <th>PTMType<i style="float: right;font-style:normal">&#8645;</i> </th>
                                <th>Target<i style="float: right;font-style:normal">&#8645;</i> </th>
                                <th type="number">Amount<i style="float: right;font-style:normal">&#8645;</i> </th>
                                <!-- <th>Origin</th> -->
                            </tr>
                            </thead>
                            <tbody>

                            <c:if test="${!empty pdbList}">
                                <C:forEach var="pdb" items="${pdbList}">
                                    <tr>
                                        <td>${pdb.type}</td>
                                        <td><a href="browseType?type=${pdb.PTMType}">${pdb.PTMType}</a></td>
                                        <td>${pdb.fullName}</td>
                                        <td>${pdb.num}</td>
                                        <!-- <td >T3SE_UniProt</td> -->
                                    </tr>
